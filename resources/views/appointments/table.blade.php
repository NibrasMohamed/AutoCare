<div class="table-responsive">
    <table class="table" id="appointments-table">
        ...
        @foreach($appointments as $appointment)
            <tr>
                       <td>{{ $appointment->customer? $appointment->customer->name:$appointment->customer_id  }}</td>
            ...
            <td>{{ $appointment->status }}</td>
                       <td class=" text-center">
                           ...
                           <div class='btn-group'>
                            ...
                            <a href="/appointment/details/get/{{ $appointment->id }}" class='btn btn-light action-btn '><i class="fa fa-eye"></i></a>
